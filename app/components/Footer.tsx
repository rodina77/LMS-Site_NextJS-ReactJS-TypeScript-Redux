...
const Footer = () => {
  return (
    <div>
      <footer className="text-center text-surface/75 text-white bg-slate-800 lg:text-left">
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className='text-center'>
              <h6 className="mb-4 text-center flex justify-center font-semibold uppercase">
                Products
              </h6>
            ...
            <div>
              ...
              {['Pricing', 'Settings', 'Orders', 'Help'].map(link => (
